...
class FirebaseAuthService {
  ...
  Future<void> deleteUserFromAuth(String uid) async {
    ...
    debugPrint('Note: User removed from Firestore but still exists in Firebase Auth.');
    debugPrint('To fully delete, use Firebase Admin SDK or delete manually from the Firebase Console.');
  }
